...
document.addEventListener("click", e => {
  if (e.target.id === "login") {
    ...
    if (window.confirm("Do you Confirm Account Deletion ?")) {
      ...
      axios
        .delete(
          `http://localhost:8080/http://localhost:5000/deleteAccount/${delUser}`
        )
        .then(result => {
    ...
    axios
      .post("http://localhost:8080/http://localhost:5000/login", {
        userName: uname,
        userPass: upass,
      })
      .then(result => {
    ...
    if (
      ...
      axios
        .post("http://localhost:8080/http://localhost:5000/signup", {
          firstName: fname,
          lastName: lname,
          userName: uname,
          userPass: upass,
          userConfirmPass: uCpass,
        })
        .then(result => {
          console.log(result);
  ...
  // Phone Javascript //
    ...
    e.target.className === "destinationIdentity" &&
